export const sample = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const sample2 = `shiny gold bags contain 2 dark red bags.
...
export const data = `shiny plum bags contain no other bags.
